...
const quickOptions: TimeOption[] = [
  ...
  { from: 'now-10y', to: 'now', display: '最近10年', section: 3 },
  { from: 'now-15y', to: 'now', display: '最近15年', section: 3 },
  { from: 'now-20y', to: 'now', display: '最近20年', section: 3 },
];

const otherOptions: TimeOption[] = [
  { from: 'now/w', to: 'now', display: '本周到现在', section: 3 },
